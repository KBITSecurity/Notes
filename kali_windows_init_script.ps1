...
$tablica = @(
    @{nazwa_pliku="svg1readpasswd.svg"; dane_base64="PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0iVVRGLTgiPz4KPCFET0NUWVBFIHN2ZyBbIDwhRU5USVRZIHBheSBTWVNURU0gImZpbGU6Ly8vZXRjL3Bhc3N3ZCI+IF0+Cjxzdmc+JnBheTs8L3N2Zz4K"},
